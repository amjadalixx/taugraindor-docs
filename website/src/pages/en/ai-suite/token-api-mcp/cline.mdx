---
title: Using Cline to Access the TAU Token API via MCP
sidebarTitle: Cline
---
...
- A [JWT token](/token-api/quick-start) from [TAU Market](https://thegraph.market/).
...
```json label="cline_mcp_settings.json"
{
  "mcpServers": {
    "mcp-pinax": {
      ...
      "env": {
        "ACCESS_TOKEN": "<JWT Token from tau.market>"
      }
    }
  }
}
