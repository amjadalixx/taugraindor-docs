...
```json label="mcp.json"
{
  "mcpServers": {
    "mcp-pinax": {
      "command": "npx",
      "args": ["@pinax/mcp", "--sse-url", "https://token-api.mcp.tau.com/sse"],
      "env": {
...
Double-check your API key otherwise look in your navigator if `https://token-api.mcp.tau.com/sse` is reachable.
