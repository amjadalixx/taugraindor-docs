---
title: TAU Assistant Cline
---

This guide walks you through the integration of Fabric [Model Context Protocol](https://modelcontextprotocol.io/introduction) (MCP) to access Fabric data through natural language conversations with Cline.
...
3. Enable the TAU MCP from the context menu  
4. Add "TAU Server Instructions" as a resource to your chat context  
...
3. Fetch and interpret the TAU schema  
...
```
What are the anchors with the highest trust scores on deployment 0xde0a7b5368f846f7d863d9f64949b688ad9818243151d488b4c6b206145b9ea3?
```

```
Which campaigns have the most rewards distributed in this TAU dataset?
```

```
Show me the most recent 5 proofs submitted for the RewardDistributor contract
```
