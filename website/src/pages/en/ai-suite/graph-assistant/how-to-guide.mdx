---
title: How To Use The TAU AI Assistant
...
> [!NOTE] Disclaimer: By using TAU AI Assistant, you acknowledge that your requests may be logged and used to improve the performance of the underlying agents. Do not share sensitive, personal, or private information.
...
2. Maps it to the correct Memory Fabric or Trust Index API endpoint
3. Executes optimized queries
4. Returns clean, structured results

You don't need to write queries or understand a Memory Fabric's schema, you simply ask.
