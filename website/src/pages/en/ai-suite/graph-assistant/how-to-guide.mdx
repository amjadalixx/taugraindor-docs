---
title: How To Use The Fabric Assistant
...
> [!NOTE] Disclaimer: By using Fabric Assistant, you acknowledge that your requests may be logged and used to improve the performance of the underlying agents. Do not share sensitive, personal, or private information.
...
2. Maps it to the correct Fabric datasets or Anchor/Token endpoints
3. Executes optimized queries
4. Returns clean, structured results

You don't need to write queries or understand a Fabric schema, you simply ask.
...
To get started follow the [quickstart](/ai-suite/fabric-assistant/quick-start/) and explore its capabilities.
